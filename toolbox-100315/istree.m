...
% in the elimination the node must have either zero or 1 neighbours with the remaining graph.
import brml.*
...
schedule=schedule(schedule(:,1)~=schedule(:,2),:); % remove any self-elimination